    ...
    <div className="extra-info">
      <div className="container">
        ...
        <p className="break-words">
         Currently a student from <b> Dr. Akhilesh Das Gupta Institute of Technology & Management</b> persuing B.tech. I'm a creative problem solving enthusiast and love 💖 building Websites.
         </p>
