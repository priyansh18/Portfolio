    ...
    <div className="extra-info">
      <div className="container">
        ...
        <p className="break-words">
         Currently a student from <b> Netaji Subhas University of Technology(NSIT) </b> pursuing M.Tech. I'm a creative problem solving enthusiast and love 💖 building Websites.
         </p>
